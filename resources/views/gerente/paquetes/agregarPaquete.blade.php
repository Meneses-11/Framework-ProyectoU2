          ...
          <div class="card-body">
            <form action="{{ route('paquete.store') }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="precio" name="precio" step="0.01" min="0.00">
            </div>

              <div class="mb-3">
                <label for="email" class="form-label">Descripción:</label>
                <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingresa o selecciona tu fecha de nacimiento" required>
              </div>

              <div class="mb-3">
                <label for="email" class="form-label">Direccion de la foto:</label>
                <input type="tel" id="direccion" name="direccion" class="form-control" placeholder="Ingresa tu direccón" required>
              </div>
