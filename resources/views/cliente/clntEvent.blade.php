                ...
                <div class="evento">
                    ...
                    <div class="datosEvento">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title fs-5" id="modalDeleteLabel{{$event->id_evento}}" style="color: black">Eliminar Evento</h5>
                        ...
                        <div class="infEvnt">
                            ...
                            <div class="texto">
                                <p>Servicio:</p>
                                @dump($event->servicios()->pluck('nombre'))
                                @if ($event->servicios()->pluck('nombre') != "")
                                    @foreach ($event->servicios()->pluck('nombre') as $servi)
                                        <p>-{{$servi}}</p>
                                    @endforeach
                                @else
                                    <p>-Ninguno</p>
                            ...
                            @else
                                ...
                                <div class="modal fade" id="modalConfirm{{$event->id_evento}}" tabindex="-1" role="dialog" aria-labelledby="modalConfirmLabel{{$event->id_evento}}" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title fs-5" id="modalConfirmLabel{{$event->id_evento}}" style="color: black">Confirmacion de Evento</h5>
                                                <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
