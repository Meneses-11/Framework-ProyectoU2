...
{{--
@section('titulobar')
  Salon eventos | {{ $evento->usuario->nombre }} 
@endsection--}}
                        ...
                        <div class="card" style="border-radius: 15px;">
                            ...
                            <div class="card-body row g-3">
                                ...
                                <div class="row mb-3 mt-3">
                                    <label for="colFormLabel" class="col-sm-3 col-form-label ">Nombre del Evento:</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="Ingrese el Nombre de su evento..." name="nombre"  value="{{ $evento->nombre }}" required>
                                    </div>
                                </div>
